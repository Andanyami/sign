...
public class AppController {
  ...
  @RequestMapping(value = "/addTercher",method = RequestMethod.POST)
    ...
    public ComResult  loginUser(String account,String pwd) throws Exception {
        Stucent tercher = new Stucent();

        tercher.setAccount(account);
        tercher.setPwd(pwd);
        Stucent Tercher1 = stucentMapper.login(tercher);
        ComResult result = new ComResult<>();
    ...
    public ComResult<Stucent>  getStudent(Integer uid){
        Stucent stucent = stucentMapper.selectByPrimaryKey(uid);

        ComResult<Stucent> result = new ComResult<>();
        result.setCode(0);
    ...
    public ComResult  addStudent(String name,String account,String pwd,String banji,String phone,String pic) throws Exception {
    ...
    public ComResult  upStudent(String name,String account,String pwd,String banji,String phone,String pic,Integer id) throws Exception {
    ...
    @RequestMapping(value = "/upStudent1",method = RequestMethod.POST)
    public ComResult  upStudent1(String name,String account,String pwd,String banji,String phone,Integer id) throws Exception {
        Stucent stucent = stucentMapper.selectByPrimaryKey(id);
        ComResult result = new ComResult<>();
        stucent.setName(name);
        stucent.setPhone(phone);
    ...
    public ComResult  addRecord(Integer sid,String time,Integer kid) throws Exception {
        Srecord sss = new Srecord();
        sss.setKid(kid);
        sss.setSid(sid);
        Srecord  srecord1= srecordMapper.getRecord(sss);

        ComResult result = new ComResult<>();
        if (srecord1==null){
            Srecord srecord = new Srecord();
            Stucent stucent = stucentMapper.selectByPrimaryKey(sid);
            if (stucent==null){
                result.setMsg("二维码不正确");
            }else {
